...
public class PhraseBank {
    ...
    private static final String[] EMERGENCY_PHRASES = {"The Police", "The Rolling Stones", "The Who", "REM"};
    private static final String EMERGENCY_TOPIC = "Bands";

    private static final int RANDOM_SEED = 12151943;
